	    ...
	    <div class="container">
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-8" style="margin-top: 15%;border: #F5F5F5 solid 2px;border-radius: 5px;background: #FCFCFC;">
					<form class="form-horizontal" id="f-login" method="post" action="../login" role="form">
					...
					<div class="form-group" id="regist" style="margin-top: 20px;padding-left: 20%;padding-right: 20%;padding-bottom: 30px;">
